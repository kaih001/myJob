...
Page({
  ...
  onLoad: function (options) {
    ...
    //   let cont_protocol_order_id = options.protocol_type.split(',')[0] == 10 ? options.protocol_order_id.split(',')[1] : options.protocol_order_id.split(',')[0]
    //   this.setData({
    //     team_id: options.team_id,
    //     project_id: options.project_id,
    //     cont_protocol_order_id: cont_protocol_order_id,
    //     protocol_order_id:options.protocol_order_id,
    //     agreement_num:options.agreement_num,
    //     protocol_type:options.protocol_type,
    //   })
    ...
    var request_data = {
      ...
      protocol_order_id: that.data.cont_protocol_order_id,
    ...
    dmNetwork.get(dmNetwork.protocol_detail, request_data, (res) => {
      if (res.data.errno == 0) {
        ...
        // if (res.data.data.protocol_info.project_type == 2 ||res.data.data.protocol_info.project_type == 3 || res.data.data.protocol_info.project_type == 4) {
        //   that.setData({
  ...
  next: function (options) {
    if (this.data.agreement_num == 2) {
      ...
      let navigateUrl =
        "../partb_declare/partb_declare?project_id=" +
        this.data.project_id +
        "&team_id=" +
        this.data.team_id +
        "&protocol_order_id=" +
        ...
        this.data.protocol_type +
        "&com_name=" +
        this.data.singData.company_info.name;
      wx.navigateTo({
        url: navigateUrl,
      });
      // this.setData({
